...
В начальный момент времени страна $X$ имеет армию численностью 21050 человек, а в распоряжении страны $Y$ армия численностью в 8900 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.32x(t) - 0.74y(t) + 2|sin(t)|
	\\   
	\frac{dy}{dt}= -0.44x(t) - 0.52y(t) + 2|cos(t)|
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.39x(t) - 0.84y(t) + 2|sin(2t)|
	\\   
	\frac{dy}{dt}= -0.42x(t)y(t) - 0.49y(t) + 2|cos(2t)|
 \end{cases}
$$
...
def P(t):
    p= math.fabs(math.sin(t))
    return p

def Q(t):
    q= math.fabs(math.cos(t))
    return q
